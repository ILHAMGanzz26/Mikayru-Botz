...
<h1 align="center">Mikayru - MD</h1>

<p align="center">
 <a href="#"><img title="MikayruBotz" src="https://img.shields.io/badge/Whatshapp BOT-green?colorA=%23ff0000&colorB=%23017e40&style=for-the-badge"></a>
</p>
...
## ```USER REPLIT```
[![Run on Repl.it](https://repl.it/badge/github/ILHAMGanzz26/Mikayru-Botz)](https://repl.it/github/ILHAMGanzz26/Mikayru-Botz)
...
```bash
git clone https://github.com/ILHAMGanzz26/Mikayru-Botz
cd Mikayru-Botz
npm install
npm update
```
